...
```{r tidy_functions, include=FALSE}
...
>
> `r quote_footer('The Greatest Possession- Elder Jeffrey R. Holland, October 2021')`
...
>
> `r quote_footer('Personal Peace in Challenging Times- Elder Quentin L. Cook, October 2021')`

> “Those who serve others **will not** sleep through the Restoration.”
>
> `r quote_footer('Are You Sleeping through the Restoration?- President Dieter F. Uchtdorf, April 2014')`
...
>
> `r quote_footer('Simply Beautiful, Beautifully Simple- Elder Gary E. Stevenson, October 2021')`
...
>
> `r quote_footer('The Peace of Christ Abolishes Enmity- Elder Dale G. Renlund, October 2021')`
...
>
> `r quote_footer('The Love of God- Elder D. Todd Christofferson, October 2021')`
...
>
> `r quote_footer('The Savior’s Abiding Compassion- Elder Ulisses Soares, October 2021')`
...
>
> `r quote_footer('Be Ye Therefore Perfect—Eventually- Elder Jeffrey R. Holland, October 2017')`
...
>
> `r quote_footer('The Plan and the Proclamation- Elder Dallin H. Oaks, October 2017')`
...
>
> `r quote_footer('Choose You This Day- Elder Dale G. Renlund, October 2018')`
...
>
> `r quote_footer('Free Forever, to Act for Themselves- Elder D. Todd Christofferson, October 2014')`
...
>
> `r quote_footer('Yes, We Can and Will Win!- Elder Ulisses Soares, April 2015')`
...
>
> `r quote_footer('Always Remember Him- Elder Gerrit W. Gong, April 2016')`
...
>
> `r quote_footer('The Things of My Soul- Elder Ronald A. Rasband, October 2021')`
...
>
> `r quote_footer('Family Councils- Elder M. Russell Ballard, April 2016')`
...
>
> `r quote_footer('Lest Thou Forget- Elder Ronald A. Rasband, October 2016')`
...
>
> `r quote_footer('Revelation for the Church, Revelation for Our Lives- President Russell M. Nelson, April 2018')`
...
>
> `r quote_footer('Family History and Temple Work: Sealing and Healing- Elder Dale G. Renlund, April 2018')`
...
>
> `r quote_footer('The Need for a Church- President Dallin H. Oaks, October 2021')`
...
>
> `r quote_footer('Pure Truth, Pure Doctrine, and Pure Revelation- President Russell M. Nelson, October 2021')`
...
>
> `r quote_footer('The Temple and Your Spiritual Foundation- President Russell M. Nelson October 2021')`
...
>
> `r quote_footer('Prayers of Faith- President Henry B. Eyring, April 2020')`
...
>
> `r quote_footer('With the Power of God in Great Glory- Elder David A. Bednar, October 2021')`
...
>
> `r quote_footer('The Faith to Ask and Then to Act- President Henry B. Eyring, October 2021')`
...
>
> `r quote_footer('Make Time for the Lord- President Russell M. Nelson, October 2021')`
...
>
> `r quote_footer('Faith Is Not by Chance, but by Choice- Elder Neil L. Anderson, October 2015')`
...
>
> `r quote_footer('Trust Again- Elder Gerrit W. Gong, October 2021')`
...
>
> `r quote_footer('“Lovest Thou Me More Than These?”- President M. Russell Ballard, October 2021')`
...
>
> `r quote_footer('Shipshape and Bristol Fashion: Be Temple Worthy—in Good Times and Bad Times- Elder Quentin L. Cook, October 2015')`
...
>
> `r quote_footer('The Name of the Church Is Not Negotiable- Elder Neil L. Anderson, October 2021')`
...
>
> `r quote_footer('Daily Restoration- Elder Dieter F. Uchtdorf, October 2021')`
...
>
> `r quote_footer('And Nothing Shall Offend Them- Elder David A. Bednar, October 2006')`
...
>
> `r quote_footer('Be Valiant in Courage, Strength, and Activity- Elder Gary E. Stevenson, October 2012')`
